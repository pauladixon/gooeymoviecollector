...
urlpatterns = [
  ...
  path('movies/<int:pk>', views.movies_detail, name='detail'),
  ...
  path('movies/<int:movie_id>/assoc_service/<int:service_id>/', views.unassoc_service, name='unassoc_service'),
  ...
  path('service/<int:pk>/update/', views.ServiceUpdate.as_view(), name='services_update'),
